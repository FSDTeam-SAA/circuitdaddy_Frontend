        ...
        <div className='flex container mx-auto items-center  justify-center '>
            <div className='flex flex-col md:flex-row items-center gap-[75px]'>
                ...
                <div className='flex gap-20 flex-wrap justify-center'>
                    <Image src="/logo1.png" alt="logos" width={900} height={900} className='w-28 h-14 object-contain ' />
                    <Image src="/logo2.png" alt="logos" width={900} height={900} className='w-24 h-14 object-contain' />
                    <Image src="/logo3.png" alt="logos" width={900} height={900} className='w-24 h-16 object-contain' />
